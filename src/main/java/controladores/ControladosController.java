 ...
 */
@WebServlet(name = "ControladosServlet", urlPatterns = {"/Controlados"})
public class ControladosController extends HttpServlet {

    private final DevolucionesDAO dao = new DevolucionesDAO();
    private final ControladosDAO controladosDAO = new ControladosDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/guia/controlados.jsp").forward(request, response);
    }
        ...
        try {
            switch (accion.toLowerCase()) {
                ...
                case "scan": {
                    ...
                    ResultadoOperacion r = controladosDAO.registrarEscaneo(docMaterial, codigo.trim(), idUsuario, 1.0);
                ...
                case "editar": {
                    ...
                    ResultadoOperacion r = controladosDAO.editarDonacion(id, cantidadInt, inc, obs);
                ...
                case "eliminar": {
                    ...
                    ResultadoOperacion r = controladosDAO.eliminarDonacionAdicional(id, docMaterial, idUsuario);
                ...
                case "cerrarguia": {
                    ...
                    ResultadoOperacion r = controladosDAO.cerrarGuia(docMaterial, idUsuario);
    ...
    private void render(HttpServletRequest request, HttpServletResponse response, long docMaterial, Integer idUsuario)
        ...
        if (docMaterial > 0) {
            ...
            if (idUsuario != null) {
                ...
                request.setAttribute("comparativo", controladosDAO.obtenerComparativoExt(docMaterial, idUsuario));
            }
        }
