 ...
 */
@WebServlet(name = "ReportesNDServlet", urlPatterns = {"/Reportes/ND"})
public class ReportNDController extends HttpServlet {

    private final RptNDDAO dao = new RptNDDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReportNDController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
try {
    ...
    private void setViewMeta(HttpServletRequest request) {
        request.setAttribute("pageTitle", "Dashboard Reportes - ND");
        request.setAttribute("pageSubtitle", "ND · Productividad e incidencias");
        request.setAttribute("baseUrl", request.getContextPath() + "/Reportes/ND");
        request.setAttribute("moduloNombre", "ND");
    }
}