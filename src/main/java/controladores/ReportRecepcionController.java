 ...
 */
@WebServlet(name = "ReportesRecepcionServlet", urlPatterns = {"/Reportes/Recepcion"})
public class ReportRecepcionController extends HttpServlet {

    private final RptRecepcionDAO dao = new RptRecepcionDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReportRecepcionController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
try {
    ...
    private void setViewMeta(HttpServletRequest request) {
        request.setAttribute("pageTitle", "Dashboard Reportes - Recepcion");
        request.setAttribute("pageSubtitle", "Recepcion · Productividad e incidencias");
        request.setAttribute("baseUrl", request.getContextPath() + "/Reportes/Recepcion");
        request.setAttribute("moduloNombre", "Recepcion");
    }
}