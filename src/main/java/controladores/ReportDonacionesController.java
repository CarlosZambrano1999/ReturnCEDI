 ...
 */
@WebServlet(name = "ReportesDonacionesServlet", urlPatterns = {"/Reportes/Donaciones"})
public class ReportDonacionesController extends HttpServlet {

    private final RptDonacionesDAO dao = new RptDonacionesDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReportDonacionesController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
try {
    ...
    private void setViewMeta(HttpServletRequest request) {
        request.setAttribute("pageTitle", "Dashboard Reportes - Donaciones");
        request.setAttribute("pageSubtitle", "Donaciones · Productividad e incidencias");
        request.setAttribute("baseUrl", request.getContextPath() + "/Reportes/Donaciones");
        request.setAttribute("moduloNombre", "Donaciones");
    }
}