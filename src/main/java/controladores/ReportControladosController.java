 ...
 */
@WebServlet(name = "ReportesControladosServlet", urlPatterns = {"/Reportes/Controlados"})
public class ReportControladosController extends HttpServlet {

    private final RptControladosDAO dao = new RptControladosDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReportControladosController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
try {
    ...
    private void setViewMeta(HttpServletRequest request) {
        request.setAttribute("pageTitle", "Dashboard Reportes - Controlados");
        request.setAttribute("pageSubtitle", "Controlados · Productividad e incidencias");
        request.setAttribute("baseUrl", request.getContextPath() + "/Reportes/Controlados");
        request.setAttribute("moduloNombre", "Controlados");
    }
}