...
public class RptDevolucionesController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // ✅ DEBUG (ahora ya con rango aplicado)
        res.put("debug_idUsuario", idUsuario);
        res.put("debug_tipo", TIPO);
        res.put("debug_desde", (desde != null ? desde.toString() : null));
        res.put("debug_hasta", (hasta != null ? hasta.toString() : null));
