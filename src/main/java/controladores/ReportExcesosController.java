 ...
 */
@WebServlet(name = "ReportesExcesosServlet", urlPatterns = {"/Reportes/Excesos"})
public class ReportExcesosController extends HttpServlet {

    private final RptExcesosDAO dao = new RptExcesosDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReportExcesosController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
try {
    ...
    private void setViewMeta(HttpServletRequest request) {
        request.setAttribute("pageTitle", "Dashboard Reportes - Excesos");
        request.setAttribute("pageSubtitle", "Excesos · Productividad e incidencias");
        request.setAttribute("baseUrl", request.getContextPath() + "/Reportes/Excesos");
        request.setAttribute("moduloNombre", "Excesos");
    }
}