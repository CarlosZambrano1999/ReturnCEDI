 ...
 */
@WebServlet(name = "DonacionesServlet", urlPatterns = {"/Donaciones"})
public class DonacionesController extends HttpServlet {

    private final DevolucionesDAO dao = new DevolucionesDAO();
    private final DonacionesDAO donacionesDAO = new DonacionesDAO();
        ...
        try {
            switch (accion.toLowerCase()) {
                ...
                case "scan": {
                    ...
                    ResultadoOperacion r = donacionesDAO.registrarEscaneo(docMaterial, codigo.trim(), idUsuario, 1.0);
                ...
                case "editar": {
                    ...
                    ResultadoOperacion r = donacionesDAO.editarDonacion(id, cantidadInt, inc, obs);
                ...
                case "eliminar": {
                    ...
                    ResultadoOperacion r = donacionesDAO.eliminarDonacionAdicional(id, docMaterial, idUsuario);
    ...
    private void render(HttpServletRequest request, HttpServletResponse response, long docMaterial, Integer idUsuario)
        ...
        if (docMaterial > 0) {
            ...
            if (idUsuario != null) {
                ...
                request.setAttribute("comparativo", donacionesDAO.obtenerComparativoExt(docMaterial, idUsuario));
            }
        }
