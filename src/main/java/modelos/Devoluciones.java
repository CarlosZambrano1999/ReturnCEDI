...
public class Devoluciones {
    ...
    public Devoluciones(Long id, Long docMaterial, String codigoSap, String codigo, String producto, String laboratorio, String presentacion, BigDecimal factor, Long usuarioId, BigDecimal cantidad, Integer incidenciaId, String observacion, Timestamp fechaScan) {
        this.id = id;
