...
public class ExcesosDAO {
    ...
    public ResultadoOperacion registrarEscaneo(long docMaterial, String codigoInput, int idUsuario, double cantidad) {
        ...
        String sql = "{CALL EXCESOS.SP_REGISTRAR_ESCANEO(?, ?, ?, ?)}";
    ...
    public List<ComparativoDocMaterialRow> obtenerComparativoExt(long docMaterial, int idUsuario) {
        ...
        String sql = "{CALL EXCESOS.SP_COMPARATIVO_DOC_MATERIAL_EXT(?, ?)}";
     ...
     * observación)
     */
    public ResultadoOperacion editarExceso(long id, double cantidad, Integer incidenciaId, String observacion) {
        ResultadoOperacion resp = new ResultadoOperacion();

        String sql = "{CALL EXCESOS.SP_EDITAR_ESCANEO(?, ?, ?, ?)}";
    ...
    public Devoluciones obtenerExcesoPorSap(long docMaterial, String codigoSap, int idUsuario) {
        String sql = "SELECT TOP 1 ID, DOC_MATERIAL, CODIGO_SAP, CANTIDAD, INCIDENCIA_ID, OBSERVACION "
                + "FROM EXCESOS.TBL_EXCESOS "
    ...
    public ResultadoOperacion eliminarExcesoAdicional(long id, long docMaterial, int idUsuario) {
        ResultadoOperacion resp = new ResultadoOperacion();
        String sql = "{CALL EXCESOS.SP_ELIMINAR_DEVOLUCION_ADICIONAL(?, ?, ?)}";
