...
public class NdDAO {
    ...
    public ResultadoOperacion registrarEscaneo(long docMaterial, String codigoInput, int idUsuario, double cantidad) {
        ...
        String sql = "{CALL ND.SP_REGISTRAR_ESCANEO(?, ?, ?, ?)}";
    ...
    public List<ComparativoDocMaterialRow> obtenerComparativoExt(long docMaterial, int idUsuario) {
        ...
        String sql = "{CALL ND.SP_COMPARATIVO_DOC_MATERIAL_EXT(?, ?)}";
     ...
     * observación)
     */
    public ResultadoOperacion editarND(long id, double cantidad, Integer incidenciaId, String observacion) {
        ResultadoOperacion resp = new ResultadoOperacion();

        String sql = "{CALL ND.SP_EDITAR_ESCANEO(?, ?, ?, ?)}";
    ...
    public Devoluciones obtenerNDPorSap(long docMaterial, String codigoSap, int idUsuario) {
    ...
    public ResultadoOperacion eliminarNDAdicional(long id, long docMaterial, int idUsuario) {
        ResultadoOperacion resp = new ResultadoOperacion();
        String sql = "{CALL ND.SP_ELIMINAR_DEVOLUCION_ADICIONAL(?, ?, ?)}";
    ...
    public ResultadoOperacion cerrarGuia(long docMaterial, int idUsuario) {
        ResultadoOperacion resp = new ResultadoOperacion();
        String sql = "{CALL ND.SP_CERRAR_GUIA(?, ?)}";
