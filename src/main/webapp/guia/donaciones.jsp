...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Donaciones - Escaneo</title>
        ...
        <div class="container py-4">
            ...
            <div class="row shadow-sm mb-3" style="background-color: white; border-radius:15px;">
                <div class="p-4 col-6">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/Donaciones" class="row g-3 align-items-end">
                    ...
                    <form id="formScan" method="post" action="<%=request.getContextPath()%>/Donaciones">
            ...
            <div class="d-flex justify-content-end mt-3">
                <form id="formCerrarGuia"
                      method="post"
                      action="<%=request.getContextPath()%>/Donaciones">
                            ...
                            <tbody>
                                ...
                                <tr class="<%=rowCls%>">
                                    ...
                                    <td><% if (esAdicional && r.getIdDevolucion() != null) {%>
                                        <form method="post" action="<%=request.getContextPath()%>/Donaciones"
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const form = document.querySelector("form[action$='/Donaciones']");
    const spinner = document.getElementById("pageSpinner");

    document.querySelectorAll("form[action$='/Donaciones']").forEach(f => {
