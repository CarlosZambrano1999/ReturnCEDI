        ...
        <div class="container py-4">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body p-4">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/Excesos" class="row g-3 align-items-end">
                    ...
                    <form id="formScan" method="post" action="<%=request.getContextPath()%>/Excesos">
            ...
            <div class="d-flex justify-content-end mt-3">
                <form id="formCerrarGuia"
                      method="post"
                      action="<%=request.getContextPath()%>/Excesos">
                            ...
                            <tbody>
                                ...
                                <tr class="<%=rowCls%>">
                                    ...
                                    <td><% if (esAdicional && r.getIdDevolucion() != null) {%>
                                        <form method="post" action="<%=request.getContextPath()%>/Excesos"
